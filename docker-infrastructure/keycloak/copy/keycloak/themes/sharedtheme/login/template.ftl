...
<#--		allow import of scripts (e.g. libphonenumbers) on subsite to save data-->
        <#nested "scriptsforreg">
	</head>
		...
		<div id="vacme-header">
			<div id="vacme-header-container">
				<div id="vacme-branding">
					<a href="${client.baseUrl}" style="display: block">
						<img alt="logo" src="${url.resourcesPath}${properties.logopath}">
