...
@Setter
@NoArgsConstructor
public class ZertifizierungsToken extends AbstractUUIDEntity<ZertifizierungsToken> {

	private static final long serialVersionUID = 2084889512677044121L;

	@NotNull @NonNull
	@Column(nullable = false, length = DBConst.DB_ZERTIFIZIERUNGS_TOKEN_MAX_LENGTH)
	@Size(max = DBConst.DB_ZERTIFIZIERUNGS_TOKEN_MAX_LENGTH)
	private String token; // Token des aktuellen Kantonsbenutzers
