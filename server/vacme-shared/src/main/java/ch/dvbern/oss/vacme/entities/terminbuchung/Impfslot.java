...
@Table(
	...
	indexes = {
		@Index(name = "IX_Impfslot_odi_bis", columnList = "ortDerImpfung_id, bis, id"),
		@Index(name = "IX_Impfslot_krankheit_odi_bis_von",
			columnList = "krankheitIdentifier, ortDerImpfung_id, bis, von, id"),
	}
)
