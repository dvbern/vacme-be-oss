...
public class IsInPastValidator implements ConstraintValidator<IsInPast, Temporal> {

	private @Nullable IsInPast annotation = null;

	@Override
	public void initialize(IsInPast annotation) {
