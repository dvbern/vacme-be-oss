...
@Table(
	indexes = {
		@Index(name = "IX_ImpfdossierFile_impfdossierId", columnList = "impfdossier_id, id"),
		@Index(name = "IX_ImpfdossierFile_impfdossierId_filetyp", columnList = "impfdossier_id, filetyp, id"),
	}
)
