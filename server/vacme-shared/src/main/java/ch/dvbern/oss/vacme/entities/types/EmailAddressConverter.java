...
import ch.dvbern.oss.vacme.entities.types.GenericStringConverter;
...
public class EmailAddressConverter extends GenericStringConverter<EmailAddress> {
	...
	private static String toExternalForm(EmailAddress email) {
		return email.getAddress();
	}

	private static EmailAddress fromString(String string) {
		return EmailAddress.fromString(string);
	}
}
