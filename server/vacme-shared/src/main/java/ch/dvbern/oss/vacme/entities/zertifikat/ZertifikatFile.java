...
@Setter
@NoArgsConstructor
public class ZertifikatFile extends AbstractUUIDEntity<ZertifikatFile> {
	...
	@NonNull
	public static ID<ZertifikatFile> toId(@NonNull UUID id) {
		return new ID<>(id, ZertifikatFile.class);
	}
}
