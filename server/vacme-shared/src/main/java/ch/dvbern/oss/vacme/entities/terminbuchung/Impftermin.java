...
@Table(
	indexes = {
		@Index(name = "IX_Impftermin_impfslot", columnList = "impfslot_id, id"),
		@Index(name = "IX_Impftermin_impffolge", columnList = "impffolge, id"),
		@Index(name = "IX_Impftermin_gebucht", columnList = "gebucht, id"),
		@Index(name = "IX_Impftermin_Impffolge_Gebucht", columnList = "impffolge, gebucht, id"),
		@Index(name = "IX_Impftermin_gebucht_folge", columnList = "impfslot_id, gebucht, impffolge, id"),
	}
)
