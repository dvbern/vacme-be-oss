...
public class ImpfdossierBuilder {
	...
	public ImpfdossierBuilder withImpfung(@NonNull LocalDate date, int impffolgeNr, @NonNull
		Impfstoff impfstoff, @NonNull KrankheitIdentifier krankheitIdentifier) {
