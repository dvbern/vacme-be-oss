...
@QuarkusTest
public class ImpfschutzCalculationQueueServiceFactoryIT {

	@Inject
	ImpfschutzCalculationQueueServiceFactory factory;
	...
	void createImpfschutzCalculationService() {
		for (KrankheitIdentifier krankheitIdentifier : KrankheitIdentifier.values()) {
			...
			Assertions.assertTrue(true, "Fuer alle Krankheiten ist ein QueueService vorhanden");
		}
	}
}
