...
public class H2DBProfile implements QuarkusTestProfile {
	...
	public Map<String, String> getConfigOverrides() {
		...
		Map<String, String> propertiesThatNeedToBeChangedForTest = Map.of(
			...
			"quarkus.datasource.jdbc.url", "jdbc:h2:mem:test;MODE=MariaDB",
    ...
    public List<TestResourceEntry> testResources() {
		return List.of(new TestResourceEntry(H2DatabaseTestResource.class)); // make sure a h2 database is started
    }
    ...
    public boolean disableGlobalTestResources() {
        return true; // we only need the h2 databse
    }
