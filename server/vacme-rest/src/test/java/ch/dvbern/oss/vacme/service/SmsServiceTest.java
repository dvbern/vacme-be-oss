...
class SmsServiceTest {
	...
	void setUp() {
		...
		smsService = spy(SmsService.class);
		smsService.link = "https://be.vacme.ch";
		smsService.sendingOfSmsDisabled = true;
	}
	...
	void testTerminbestaetigungSMS() {
		...
		Mockito.verify(smsService).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessageBooster, infos.getRegistrierung());
		...
		smsService.sendTerminbestaetigungSMS(infos.getImpfdossier(), impftermin, empfaenger);
		Mockito.verify(smsService).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessageBasisTermin, infos.getRegistrierung());
		...
		smsService.sendTerminbestaetigungSMS(infos.getImpfdossier(), impftermin, empfaenger);
		Mockito.verify(smsService).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessageOhneTerminbuchung, infos.getRegistrierung());
		...
		smsService.sendTerminbestaetigungSMS(infos.getImpfdossier(), impftermin, empfaenger);
		Mockito.verify(smsService).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessageOhneTerminbuchungMobilesOdi, infos.getRegistrierung());
		...
		smsService.sendTerminbestaetigungSMS(infos.getImpfdossier(), impftermin, empfaenger);
		Mockito.verify(smsService).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessageNichtVerwalteterOdi, infos.getRegistrierung());
	}
	...
	void testOdiRegistrierungSms() {
		...
		Mockito.verify(smsService).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessageAffenpocken, infos.getRegistrierung());
	}
	...
	void testFreigabeBoosterSms() {
		...
		Mockito.verify(smsService).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessage, infos.getRegistrierung());
	}
	...
	void testFreigabeBoosterSmsWithPreviousImpfung() {
		...
		Mockito.verify(smsService).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessage2, infos.getRegistrierung());
	}
	...
	void testFreigabeBossterSmsFR() {
		...
		Mockito.verify(smsService).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessageFR, infos.getRegistrierung());
	}
	...
	void testTerminbestaetigungFsmeForWell() {
		...
		smsService.sendTerminbestaetigungSMS(infos.getImpfdossier(), impftermin, empfaenger);
		Mockito.verify(smsService, never()).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessageBooster, infos.getRegistrierung());
		...
		smsService.sendTerminbestaetigungSMS(infos.getImpfdossier(), impftermin, empfaenger);
		Mockito.verify(smsService, never()).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessageBasisTermin, infos.getRegistrierung());
		...
		smsService.sendTerminbestaetigungSMS(infos.getImpfdossier(), impftermin, empfaenger);
		Mockito.verify(smsService, never()).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessageOhneTerminbuchung, infos.getRegistrierung());
		...
		smsService.sendTerminbestaetigungSMS(infos.getImpfdossier(), impftermin, empfaenger);
		Mockito.verify(smsService, never()).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessageOhneTerminbuchungMobilesOdi, infos.getRegistrierung());
		...
		smsService.sendTerminbestaetigungSMS(infos.getImpfdossier(), impftermin, empfaenger);
		Mockito.verify(smsService, never()).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessageNichtVerwalteterOdi, infos.getRegistrierung());
	}
	...
	void testFreigabeBoosterSmsFsmeForWell() {
		...
		Mockito.verify(smsService, never()).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessage, infos.getRegistrierung());
	}
	...
	void testFreigabeBoosterSmsWithPreviousImpfungFsmeForWell() {
		...
		Mockito.verify(smsService, never()).sendSMSToRegistrierung(EMPFAENGER_MOBILE_NUMMER, expectedMessage2, infos.getRegistrierung());
	}
