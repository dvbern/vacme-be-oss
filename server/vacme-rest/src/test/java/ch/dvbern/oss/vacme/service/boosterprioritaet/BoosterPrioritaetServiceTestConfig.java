...
@Value
public class BoosterPrioritaetServiceTestConfig {
	int freigbameMonthsNachImpfungAb12Jaehrig;
	int freigbameMonthsNachImpfungAb65Jaehrig;
	int freigbameMonthsNachImpfungAb80Jaehrig;
	int freigbameMonthsNachImpfungPrioA;

	int freigabeMonthsNachImpfung;
	int freigabeMonthsNachKrankheit;
	LocalDate cutoffSelbstzahler;
