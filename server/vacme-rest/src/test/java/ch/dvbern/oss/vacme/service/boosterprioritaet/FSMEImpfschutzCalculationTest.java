...
class FSMEImpfschutzCalculationTest {
	...
	private static final ChronoUnit FREIGABE_OFFSET_NO_IMPFSCHUTZ_SCHNELLSCHEMA_FIRST_IMPFUNG_UNIT_ENCEPUR = ChronoUnit.DAYS;

	private static final int FREIGABE_OFFSET_NO_IMPFSCHUTZ_SCHNELLSCHEMA_SECOND_IMPFUNG_ENCEPUR = 14;
	private static final ChronoUnit FREIGABE_OFFSET_NO_IMPFSCHUTZ_SCHNELLSCHEMA_SECOND_IMPFUNG_UNIT_ENCEPUR = ChronoUnit.DAYS;

	private static final int FREIGABE_OFFSET_NO_IMPFSCHUTZ_SCHNELLSCHEMA_FIRST_BOOSTER_ENCEPUR = 12;
	private static final ChronoUnit FREIGABE_OFFSET_NO_IMPFSCHUTZ_SCHNELLSCHEMA_FIRST_BOOSTER_UNIT_ENCEPUR = ChronoUnit.MONTHS;

	private static final int FREIGABE_OFFSET_NO_IMPFSCHUTZ_SCHNELLSCHEMA_FIRST_IMPFUNG_FSME_IMMUNE = 14;
	private static final ChronoUnit FREIGABE_OFFSET_NO_IMPFSCHUTZ_SCHNELLSCHEMA_FIRST_IMPFUNG_UNIT_FSME_IMMUNE = ChronoUnit.DAYS;
	...
	void setUp() {
		...
		fsmeImpfschutzcalculationService = new FSMEImpfschutzcalculationService(specifiedImpfstoffe);
	}
	...
	public void testFsmeFreigabedatumAndImpfschutz(
		...
		calculateImpfschutzAndCheckResults(expectedGrundimmunisiert, expectedFreigabedatum, expectedImpfschutzBis, builder);
	}
	...
	public void testAllowedImpfstoffAfterEncepur() {
		...
		final ImpfinformationDto infos = builder.getInfos();
		Impfschutz impfschutz = fsmeImpfschutzcalculationService.calculateImpfschutz(builder.getFragebogen(), infos).orElse(null);
		Assertions.assertNotNull(impfschutz);
		Assertions.assertNull(impfschutz.getImmunisiertBis());
		Assertions.assertEquals(impfung1Date
		...
		Impfschutz impfschutz2 = fsmeImpfschutzcalculationService.calculateImpfschutz(builder.getFragebogen(), infos2).orElse(null);
		Assertions.assertNotNull(impfschutz2);
		Assertions.assertNull(impfschutz2.getImmunisiertBis());
		Assertions.assertEquals(impfung2Date
				.plus(FREIGABE_OFFSET_NO_IMPFSCHUTZ_SECOND_IMPFUNG_FSME_IMMUNE, FREIGABE_OFFSET_NO_IMPFSCHUTZ_SECOND_IMPFUNG_UNIT_FSME_IMMUNE)
				.atStartOfDay(),
		...
		Impfschutz impfschutz3 = fsmeImpfschutzcalculationService.calculateImpfschutz(builder.getFragebogen(), infos3).orElse(null);
