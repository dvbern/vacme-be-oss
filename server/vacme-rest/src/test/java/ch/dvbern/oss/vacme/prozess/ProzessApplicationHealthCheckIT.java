...
public class ProzessApplicationHealthCheckIT extends AbstractProzessIT {
	...
	void allQueriesWorking() {
		...
		final ResultDTO healthCheckNichtGeschickteRegistrierungFile =
			applicationHealthRepo.getHealthCheckNichtGeschickteRegistrierungFile();
		Assertions.assertNotNull(healthCheckNichtGeschickteRegistrierungFile);
