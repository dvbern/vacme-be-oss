...
class PhoneNumberUtilTest {
	...
	public void isMobileNumber() {
		...
		Assertions.assertTrue(PhoneNumberUtil.isMobileNumber("+41 76 309 30 58ww"));
	...
	public void processMobileNumberTest() {
		...
		assertEquals("+41781231212", PhoneNumberUtil.processMobileNumber("+41 78 123q12 12w"));
		assertEquals("+41781231212", PhoneNumberUtil.processMobileNumber("+41 78tq 123q12 12w"));
	}
