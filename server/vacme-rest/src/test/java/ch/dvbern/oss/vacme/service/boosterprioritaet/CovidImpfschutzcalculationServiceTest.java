...
class CovidImpfschutzcalculationServiceTest {
	...
	private static final LocalDate GEBURTSDATUM_MORGEN_12_JAEHRIG = LocalDate.now().minusYears(12).plusDays(1);
		// wird morgen 12
	...
	private static final LocalDate GEBURTSDATUM_MORGEN_80_JAEHRIG = LocalDate.now().minusYears(80).plusDays(1);
		// wird morgen 80
	...
	void setUp() {
		...
		boosterPrioritaetService =
			new CovidImpfschutzcalculationService(specifiedImpfstoffe, Mockito.mock(VacmeSettingsService.class));
		initRulesForTest();
	}
	...
	private Impfschutz calculateImpfschutzForExterneImpfungDaten(
		...
		impfdossier.setVollstaendigerImpfschutzTyp(vollstaendigerImpfschutz ?
		...
		if (datumDerBoosterImpfung == null) {
			impfinformationDto = new ImpfinformationDto(KrankheitIdentifier.COVID,
	...
	private Impfschutz calculateImpfschutzForVacMeImpfungen(Pair<Fragebogen, ImpfinformationDto> fragebogenAndImpfinfo) {
		return boosterPrioritaetService.calculateImpfschutz(
			fragebogenAndImpfinfo.getLeft(),
			fragebogenAndImpfinfo.getRight()).orElse(null);
	}
	...
	private Pair<Fragebogen, ImpfinformationDto> createFragebogenAndImpfinfoPairForTesting(
		...
		impfdossier.setVollstaendigerImpfschutzTyp(vollstaendigerImpfschutz ?
			...
			null);
		Impfung impfung1 =
			createImpfung(impfstoffe.size() == 1 ? datumDerLetztenImpfung : datumDerLetztenImpfung.minusDays(28));
	...
	public void testExterneImpfungMitVollstaendigenImpfschutzUndStandardRegel() {
		...
		Assertions.assertEquals(
			calculateGenesenDatumAfterGrundschutz(DATUM_LETZTE_GRUNDIMPFUNG),
			impfschutz.getImmunisiertBis());
		Assertions.assertEquals(DATUM_LETZTE_GRUNDIMPFUNG.plusMonths(FREIGBAME_MONTHS_NACH_IMPFUNG_AB_12_JAEHRIG)
			.atStartOfDay(), impfschutz.getFreigegebenNaechsteImpfungAb());
	}
	...
	public void testExterneImpfungMitVollstaendigenImpfschutzUndGruppeA() {
		...
		Assertions.assertEquals(
			calculateGenesenDatumAfterGrundschutz(DATUM_LETZTE_GRUNDIMPFUNG),
			impfschutz.getImmunisiertBis());
		Assertions.assertEquals(DATUM_LETZTE_GRUNDIMPFUNG.plusMonths(FREIGBAME_MONTHS_NACH_IMPFUNG_PRIO_A)
			.atStartOfDay(), impfschutz.getFreigegebenNaechsteImpfungAb());
	}
	...
	public void testExterneImpfungMitVollstaendigenImpfschutzUnter12JahrenWirdAber12() {
		...
		Assertions.assertEquals(
			...
			impfschutz.getFreigegebenNaechsteImpfungAb().toLocalDate());
	}
	...
	public void testExterneImpfungMitBoosterImpfschutzUndStandardRegel() {
		...
		Assertions.assertNotNull(impfschutz);
		Assertions.assertEquals(
			calculateGenesenDatumAfterGrundschutz(DATUM_BOOSTER_GRUNDIMPFUNG),
			impfschutz.getImmunisiertBis());
		Assertions.assertEquals(DATUM_BOOSTER_GRUNDIMPFUNG.plusMonths(FREIGBAME_MONTHS_NACH_IMPFUNG_AB_12_JAEHRIG)
			.atStartOfDay(), impfschutz.getFreigegebenNaechsteImpfungAb());
	}
	...
	public void testVacMeImpfungMitVollstaendigenImpfschutzUndStandardRegel() {
		...
		Assertions.assertTrue(impfschutz.getErlaubteImpfstoffeCollection()
			.contains(Constants.PFIZER_BIONTECH_BIVALENT_UUID));
	...
	public void testVacMeImpfungMitNovovaxGrundimmunisierung() {
		...
		Assertions.assertEquals(
			...
			impfschutz.getImmunisiertBis());
		Assertions.assertEquals(DATUM_LETZTE_GRUNDIMPFUNG.plusMonths(FREIGBAME_MONTHS_NACH_IMPFUNG_AB_12_JAEHRIG)
			.atStartOfDay(), impfschutz.getFreigegebenNaechsteImpfungAb()); // todo homa warum ist das 6 Monate
		Assertions.assertEquals(5, impfschutz.getErlaubteImpfstoffeCollection().size());
		Assertions.assertTrue(impfschutz.getErlaubteImpfstoffeCollection().contains(Constants.MODERNA_UUID));
		Assertions.assertTrue(impfschutz.getErlaubteImpfstoffeCollection().contains(Constants.MODERNA_BIVALENT_UUID));
		Assertions.assertTrue(impfschutz.getErlaubteImpfstoffeCollection().contains(Constants.PFIZER_BIONTECH_UUID));
	...
	public void testVacMeImpfungMitUeber65RegelUndPfizer() {
		...
		Assertions.assertEquals(
			calculateGenesenDatumAfterGrundschutz(DATUM_LETZTE_GRUNDIMPFUNG),
			impfschutz.getImmunisiertBis());
		Assertions.assertEquals(DATUM_LETZTE_GRUNDIMPFUNG.plusMonths(FREIGBAME_MONTHS_NACH_IMPFUNG_AB_65_JAEHRIG)
			.atStartOfDay(), impfschutz.getFreigegebenNaechsteImpfungAb());
	}
	...
	public void testVacMeImpfungMitJanssenOhneKrankheit() {
		...
		Assertions.assertEquals(
			impfdatum.plusMonths(FREIGBAME_MONTHS_NACH_IMPFUNG_AB_65_JAEHRIG).atStartOfDay(),
	...
	public void testVacMeImpfungMitUeber65RegelUndPfizerMitBooster() {
		...
		Assertions.assertEquals(
			calculateGenesenDatumAfterGrundschutz(DATUM_BOOSTER_GRUNDIMPFUNG),
			impfschutz.getImmunisiertBis());
		Assertions.assertEquals(DATUM_BOOSTER_GRUNDIMPFUNG.plusMonths(FREIGBAME_MONTHS_NACH_IMPFUNG_AB_65_JAEHRIG)
			.atStartOfDay(), impfschutz.getFreigegebenNaechsteImpfungAb());
	}
	...
	public void testVacMeImpfungMitUeber65RegelUndPfizerMitBoosterErst74JahreAlt() {
		...
		Assertions.assertEquals(
			...
			impfschutz.getImmunisiertBis());
		Assertions.assertEquals(
			LocalDate.now().plusDays(5).atStartOfDay(),
			impfschutz.getFreigegebenNaechsteImpfungAb());
	}
	...
	public void testVacMeImpfungMitUeber65RegelUndImmobil() {
		...
		Assertions.assertEquals(
			calculateGenesenDatumAfterGrundschutz(DATUM_LETZTE_GRUNDIMPFUNG),
			impfschutzOk.getImmunisiertBis());
		Assertions.assertEquals(DATUM_LETZTE_GRUNDIMPFUNG.plusMonths(FREIGBAME_MONTHS_NACH_IMPFUNG_AB_65_JAEHRIG)
			.atStartOfDay(), impfschutzOk.getFreigegebenNaechsteImpfungAb());
	...
	public void testVacMeImpfungImmobilAndLaterChangedToMobil() {
		...
		Assertions.assertEquals(
			calculateGenesenDatumAfterGrundschutz(DATUM_LETZTE_GRUNDIMPFUNG),
			impfschutzNeuFreigegeben.getImmunisiertBis());
		Assertions.assertEquals(DATUM_LETZTE_GRUNDIMPFUNG.plusMonths(FREIGBAME_MONTHS_NACH_IMPFUNG_AB_65_JAEHRIG)
			.atStartOfDay(), impfschutzNeuFreigegeben.getFreigegebenNaechsteImpfungAb());
		Assertions.assertEquals(DATUM_LETZTE_GRUNDIMPFUNG.plusMonths(FREIGBAME_MONTHS_NACH_IMPFUNG_AB_65_JAEHRIG)
			.atStartOfDay(), impfschutzNeuFreigegeben.getFreigegebenAbSelbstzahler());
	...
	public void testBe65jaehrigerMitPunkte() {
		...
		Assertions.assertNotNull(impfschutz);
		Assertions.assertEquals(calculateGenesenDatumAfterGrundschutz(LocalDate.now()),
			impfschutz.getImmunisiertBis());
		Assertions.assertEquals(
			LocalDate.now().plusMonths(FREIGABE_MONTHS_NACH_IMPFUNG).atStartOfDay(),
			impfschutz.getFreigegebenNaechsteImpfungAb());
	}
	...
	public void testBe80jaehrig() {
		...
		Assertions.assertNotNull(impfschutz);
		Assertions.assertEquals(
			calculateGenesenDatumAfterGrundschutz(LocalDate.now().minusYears(1)),
			impfschutz.getImmunisiertBis());
		Assertions.assertEquals(
			LocalDate.now().minusYears(1).plusMonths(FREIGABE_MONTHS_NACH_IMPFUNG).atStartOfDay(),
			impfschutz.getFreigegebenNaechsteImpfungAb());
	}
	...
	public void testZh65jaehrigerOhnePunkte() {
		...
		Assertions.assertEquals(calculateGenesenDatumAfterGrundschutz(LocalDate.now()),
			impfschutz.getImmunisiertBis());
		Assertions.assertEquals(
			LocalDate.now().plusMonths(6).plusDays(0).atStartOfDay(),
			impfschutz.getFreigegebenNaechsteImpfungAb());
	}
	...
	public void testZh65jaehrigerOhnePunkteMitAlterImpfung() {
		...
		Assertions.assertEquals(
			...
			impfschutz.getImmunisiertBis());
		Assertions.assertEquals(
			LocalDate.now().minusYears(1).plusMonths(6).atStartOfDay(),
			impfschutz.getFreigegebenNaechsteImpfungAb());
	}
	...
	public void testDisableKrankheitOffset() {
		...
		Assertions.assertEquals(
			calculateGenesenDatumAfterGrundschutz(impfdatum),
			impfschutzWithRelKrankheit.getImmunisiertBis());
		Assertions.assertEquals(positivGetestetDatum.atStartOfDay(),
			impfschutzWithRelKrankheit.getFreigegebenNaechsteImpfungAb(),
	...
	public void test80jaehrigZweiterBooster() {
		...
		Assertions.assertNotNull(impfschutz);
		Assertions.assertEquals(
			lastImpfungDate.plusMonths(FREIGBAME_MONTHS_NACH_IMPFUNG_AB_80_JAEHRIG).atStartOfDay(),
			impfschutz.getFreigegebenNaechsteImpfungAb());
	}
	...
	public void testMorgen80jaehrigZweiterBooster() {
		...
		Assertions.assertEquals(
			dateBoosterImpfung.plusMonths(FREIGBAME_MONTHS_NACH_IMPFUNG_AB_80_JAEHRIG),
			impfschutz.getFreigegebenAbSelbstzahler().toLocalDate());
	}
	...
	public void testMorgen12jaehrigBooster() {
		...
		Assertions.assertTrue(impfschutz.getErlaubteImpfstoffeCollection().contains(Constants.NOVAVAX_UUID));
		Assertions.assertEquals(
			dateImpfung2.plusDays(IMPFSCHUTZ_DAUER_DAYS).atStartOfDay(),
			impfschutz.getImmunisiertBis());
	...
	public void test25aehrigrMitPfizerKinderGrundimmunisierungBooster() {
		...
		Assertions.assertEquals(
			...
			impfschutz.getImmunisiertBis());
		Assertions.assertEquals(
			dateImpfung2.plusMonths(FREIGBAME_MONTHS_NACH_IMPFUNG_AB_12_JAEHRIG).atStartOfDay(),
			impfschutz.getFreigegebenAbSelbstzahler());
		Assertions.assertEquals(
			dateImpfung2.plusMonths(FREIGBAME_MONTHS_NACH_IMPFUNG_AB_12_JAEHRIG).atStartOfDay(),
			impfschutz.getFreigegebenNaechsteImpfungAb());
