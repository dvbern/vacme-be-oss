...
public class FsmeImpfschutzCalcQueueService implements ImpfschutzCalculationQueueService {

	private final BoosterQueueRepo boosterQueueRepo;

	@Override
	public long removeAllSuccessfullQueueEntries() {
		return boosterQueueRepo.removeAllSuccessfullEntries(KrankheitIdentifier.FSME);
	}

	@Override
	public int queueRelevantRegsForImpfschutzRecalculation() {
		return boosterQueueRepo.queueRelevantRegsForImpfschutzRecalculationFsme();
	}
}
