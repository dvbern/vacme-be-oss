...
public class NextTerminCacheService {
	...
	void init(){
		...
		CacheLoader<? super Pair<ID<OrtDerImpfung>, KrankheitIdentifier>, Optional<LocalDateTime>> loaderForNextSlotWithFreeTerminN;
	...
	public LocalDateTime getNextFreierImpfterminThroughCache(
		...
		return ortDerImpfungService.getNextFreierImpftermin(ortDerImpfungId, impffolge, otherTerminDate, limitMaxFutureDate, krankheit);
	}
}
