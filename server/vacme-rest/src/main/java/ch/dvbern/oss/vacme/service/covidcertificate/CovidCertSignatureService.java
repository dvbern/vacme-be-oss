...
public class CovidCertSignatureService {
	...
	private void initKeys() {
		if (privateKey == null) {
			try {
				privateKey = CovidCertKeyUtil.loadPrivateKey(vacmeSettingsService.getCovidCertApiPrivateKeyPath(), vacmeSettingsService.getCovidCertApiPassword(), vacmeSettingsService.getCovidCertApiKeyAlias());
