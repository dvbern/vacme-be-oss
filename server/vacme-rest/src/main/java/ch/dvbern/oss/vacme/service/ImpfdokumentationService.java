...
public class ImpfdokumentationService {
	...
	public ImpfinformationDto createImpfung(
		...
		case ZWEITE_IMPFUNG:
			...
			break;
		case BOOSTER_IMPFUNG:
			ValidationUtil.validateBoosterImpfungEinTagNachBisherige(infos, timestampOfImpfung, vacmeSettingsService.getValidateSameDayImpfungen());
			break;
		}
	...
	private void validateImpfungEinTagNachBisherige(
		...
		if (vacmeSettingsService.getValidateSameDayImpfungen()) {
