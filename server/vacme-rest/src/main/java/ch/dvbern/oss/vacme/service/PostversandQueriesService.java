...
public class PostversandQueriesService {
	...
	public List getPostversandQueryTerminBestaetigung_regnum() {
		...
		try {
			...
			nativeQueryTerminBestaetigung_regnum.setHint(DB_QUERY_TIMEOUT_HINT, vacmeSettingsService.getDbQueryTimeoutInSeconds());
	...
	public List getPostversandQueryTerminBestaetigung_dumpfile() {
		...
		try {
			...
			nativeQueryTerminBestaetigung_dumpfile.setHint(DB_QUERY_TIMEOUT_HINT, vacmeSettingsService.getDbQueryTimeoutInSeconds());
	...
	public List getPostversandQueryTerminBestaetigung_regID() {
		...
		try {
			...
			nativeQueryTerminBestaetigung_regID.setHint(DB_QUERY_TIMEOUT_HINT, vacmeSettingsService.getDbQueryTimeoutInSeconds());
	...
	public List getPostversandQueryTerminBestaetigung_update() {
		...
		try {
			...
			nativeQueryTerminBestaetigung_update.setHint(DB_QUERY_TIMEOUT_HINT, vacmeSettingsService.getDbQueryTimeoutInSeconds());
	...
	public List getPostversandQueryTerminAbsage_regnum() {
		...
		try {
			...
			nativeQueryTerminAbsage_regnum.setHint(DB_QUERY_TIMEOUT_HINT, vacmeSettingsService.getDbQueryTimeoutInSeconds());
	...
	public List getPostversandQueryTerminAbsage_dumpfile() {
		...
		try {
			...
			nativeQueryTerminAbsage_dumpfile.setHint(DB_QUERY_TIMEOUT_HINT, vacmeSettingsService.getDbQueryTimeoutInSeconds());
	...
	public List getPostversandQueryTerminAbsage_regID() {
		...
		try {
			...
			nativeQueryTerminAbsage_regID.setHint(DB_QUERY_TIMEOUT_HINT, vacmeSettingsService.getDbQueryTimeoutInSeconds());
	...
	public List getPostversandQueryTerminAbsage_update() {
		...
		try {
			...
			nativeQueryTerminAbsage_update.setHint(DB_QUERY_TIMEOUT_HINT, vacmeSettingsService.getDbQueryTimeoutInSeconds());
	...
	public List getPostversandQueryOnboardingLetter_regnum() {
		...
		try {
			...
			nativeQueryPostversandQueryOnboardingLetter_regnum.setHint(DB_QUERY_TIMEOUT_HINT, vacmeSettingsService.getDbQueryTimeoutInSeconds());
	...
	public List getPostversandQueryOnboardingLetter_regID() {
		...
		try {
			...
			nativeQueryPostversandQueryOnboardingLetter_regID.setHint(DB_QUERY_TIMEOUT_HINT, vacmeSettingsService.getDbQueryTimeoutInSeconds());
	...
	public List getPostversandQueryOnboardingLetter_update() {
		...
		try {
			...
			nativeQueryPostversandQueryOnboardingLetter_update.setHint(DB_QUERY_TIMEOUT_HINT, vacmeSettingsService.getDbQueryTimeoutInSeconds());
