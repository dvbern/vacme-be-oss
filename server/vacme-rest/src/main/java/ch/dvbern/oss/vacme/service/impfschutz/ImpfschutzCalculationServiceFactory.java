...
import ch.dvbern.oss.vacme.service.boosterprioritaet.CovidImpfschutzcalculationService;
...
public class ImpfschutzCalculationServiceFactory {
	...
	@Inject
	Instance<CovidImpfschutzcalculationService> boosterPrioritaetService;
