...
public class KorrekturService {
	...
	public void impfungKorrigieren(
		...
		final boolean needToRevoke = ImpfungKorrekturJax.needToRevoke(impfinformation.getImpfdossier(),
	...
	public void impfungLoeschen(
		...
		// TODO VACME-2692: Löschung ans Archivsystem melden
		// sicherstellen dass Infos fuer recalculation neu geladen werden
		boosterService.recalculateImpfschutzAndStatusmovesForSingleRegWithReload(
			registrierung,
	...
	public void personendatenKorrigieren(
		...
		for (ImpfinformationDto infos : infosPerImpfdossier) {
			...
			VacmeDecoratorFactory.getDecorator(infos.getKrankheitIdentifier())
				.recalculateVollstaendigerImpfschutzTypBasedOnImmunsupprimiert(infos,
					fragebogen.getImmunsupprimiert());
