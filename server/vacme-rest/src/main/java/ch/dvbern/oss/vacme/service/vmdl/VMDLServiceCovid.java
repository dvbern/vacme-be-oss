...
public class VMDLServiceCovid extends VMDLServiceAbstract<VMDLUploadCovidJax> {
	...
	private List<VMDLUploadCovidJax> findVMDLPendenteCovidImpfungen() {
		if (run3QueriesSettingEnabled()) {
			return vmdlRepo.getVMDLPendenteImpfungen3QueriesCovid(uploadChunkLimit, reportingUnitID);
		}
		return vmdlRepo.getVMDLPendenteImpfungen2QueriesCovid(uploadChunkLimit, reportingUnitID);
	}
