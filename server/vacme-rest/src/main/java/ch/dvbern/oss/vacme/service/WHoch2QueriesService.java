...
public class WHoch2QueriesService {
	...
	public List getWHoch2QueryRegistrierungen() {
		...
		try {
			...
			nativeQueryRegistrierungen.setHint(DB_QUERY_TIMEOUT_HINT, dbQueryTimeoutInSeconds);
	...
	public List getWHoch2QueryImpfungen() {
		...
		try {
			...
			nativeQueryImpfungen.setHint(DB_QUERY_TIMEOUT_HINT, dbQueryTimeoutInSeconds);
	...
	public List getWHoch2QueryImpfslots() {
		...
		try {
			...
			nativeQueryImpfslots.setHint(DB_QUERY_TIMEOUT_HINT, dbQueryTimeoutInSeconds);
	...
	public List getWHoch2EdorexQueryRegistrierungen() {
		try {
			...
			nativeQueryEdorexRegistrierungen.setHint(DB_QUERY_TIMEOUT_HINT, dbQueryTimeoutInSeconds);
	...
	public List getWHoch2EdorexQueryImpfungen() {
		try {
			...
			nativeQueryEdorexImpfungen.setHint(DB_QUERY_TIMEOUT_HINT, dbQueryTimeoutInSeconds);
	...
	public List getWHoch2EdorexQueryImpfslots() {
		try {
			...
			nativeQueryEdorexImpfslots.setHint(DB_QUERY_TIMEOUT_HINT, dbQueryTimeoutInSeconds);
