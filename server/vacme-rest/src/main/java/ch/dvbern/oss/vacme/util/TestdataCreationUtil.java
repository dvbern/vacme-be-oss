...
public class TestdataCreationUtil {
	...
	public static ExternesZertifikat createExternesZertifikat(
	...
	public static Impfstoff createImpfstoffModerna() {
		Impfstoff impfstoff = createImpfstoff(Constants.MODERNA_UUID,
			"Spikevax",
			"Moderna",
			2,
			CovidCertificateVaccinesNames.MODERNA.getCode(),
			"30380777700688",
			ZulassungsStatus.EMPFOHLEN,
			ZulassungsStatus.EMPFOHLEN,
			Impfstofftyp.MRNA);
		impfstoff.getImpfempfehlungenChGrundimmunisierung()
			.add(new ImpfempfehlungChGrundimmunisierung(1, 1, impfstoff));
		impfstoff.getImpfempfehlungenChGrundimmunisierung()
			.add(new ImpfempfehlungChGrundimmunisierung(2, 0, impfstoff));
	...
	public static Impfstoff createImpfstoffModernaBivalent() {
		Impfstoff impfstoff = createImpfstoff(Constants.MODERNA_BIVALENT_UUID,
			"Spikevax® Bivalent Original / Omicron",
			"Moderna",
			2,
			CovidCertificateVaccinesNames.MODERNA_BIVALENT.getCode(),
			"7680690090012",
			ZulassungsStatus.EMPFOHLEN,
			ZulassungsStatus.EMPFOHLEN,
			Impfstofftyp.MRNA);
	...
	public static Impfstoff createImpfstoffPfizer() {
		Impfstoff impfstoff = createImpfstoff(Constants.PFIZER_BIONTECH_UUID,
			"Comirnaty",
			"Pfizer/BioNTech",
			2,
			CovidCertificateVaccinesNames.PFIZER_BIONTECH.getCode(),
			"04260703260118",
			ZulassungsStatus.EMPFOHLEN,
			ZulassungsStatus.EMPFOHLEN,
			Impfstofftyp.MRNA);
	...
	public static Impfstoff createImpfstoffPfizerKinder() {
		Impfstoff impfstoff = createImpfstoff(Constants.PFIZER_BIONTECH_KINDER_UUID,
			"Comirnaty Kinder",
			"Pfizer/BioNTech",
			2,
			"Comirnaty Kinder",
			"?pfizer-kinder?",
			ZulassungsStatus.EMPFOHLEN,
			ZulassungsStatus.NICHT_ZUGELASSEN,
			Impfstofftyp.MRNA); // todo team wie wird das eingeschraenkt sobald fuer Booster freigegeben?
		impfstoff.getImpfempfehlungenChGrundimmunisierung()
			.add(new ImpfempfehlungChGrundimmunisierung(1, 1, impfstoff));
		impfstoff.getImpfempfehlungenChGrundimmunisierung()
			.add(new ImpfempfehlungChGrundimmunisierung(2, 0, impfstoff));
	...
	public static Impfstoff createImpfstoffPfizerBivalent() {
		Impfstoff impfstoff = createImpfstoff(Constants.PFIZER_BIONTECH_BIVALENT_UUID,
			"Comirnaty Bivalent Original/Omicron BA.1®",
			"Pfizer/BioNTech",
			2,
			CovidCertificateVaccinesNames.PFIZER_BIONTECH_BIVALENT.getCode(),
			"7680690470012",
			ZulassungsStatus.EMPFOHLEN,
			ZulassungsStatus.EMPFOHLEN,
			Impfstofftyp.MRNA);
	...
	public static Impfstoff createImpfstoffAstraZeneca() {
		Impfstoff impfstoff = createImpfstoff(Constants.ASTRA_ZENECA_UUID,
			"VAXZEFRIA",
			"AstraZeneca",
			2,
			CovidCertificateVaccinesNames.EU_1_21_1529.getCode(),
			"?astrazeneca?",
	...
	public static Impfstoff createImpfstoffJanssen() {
		Impfstoff impfstoff = createImpfstoff(Constants.JANSSEN_UUID,
			"COVID-19 vaccine",
			"Johnson & Johnson",
			1,
			CovidCertificateVaccinesNames.EU_1_20_1525.getCode(),
			"?janssen?",
			ZulassungsStatus.ZUGELASSEN,
			ZulassungsStatus.ZUGELASSEN,
			Impfstofftyp.ANDERE);
		impfstoff.getImpfempfehlungenChGrundimmunisierung()
			.add(new ImpfempfehlungChGrundimmunisierung(1, 0, impfstoff));
		impfstoff.setKrankheiten(createKrankheiten(KrankheitIdentifier.COVID));
		return impfstoff;
	}

	public static Impfstoff createImpfstoffCovaxin() {
		Impfstoff impfstoff = createImpfstoff(Constants.COVAXIN_UUID,
			"Covaxin",
			"Bharat Biotech International Ltd",
			2,
			CovidCertificateVaccinesNames.Covaxin.getCode(),
			"?covaxin?",
			ZulassungsStatus.EXTERN_ZUGELASSEN,
			ZulassungsStatus.EXTERN_ZUGELASSEN,
			Impfstofftyp.ANDERE);
	...
	public static Impfstoff createImpfstoffSinopharm() {
		Impfstoff impfstoff = createImpfstoff(Constants.SINOPHARM_UUID,
			"SARS-CoV-2 Vaccine (Vero Cell)",
			"Sinopharm",
			2,
			CovidCertificateVaccinesNames.BBIBP_CorV.getCode(),
			"?covaxin?",
			ZulassungsStatus.EXTERN_ZUGELASSEN,
			ZulassungsStatus.EXTERN_ZUGELASSEN,
			Impfstofftyp.ANDERE);
		impfstoff.getImpfempfehlungenChGrundimmunisierung()
			.add(new ImpfempfehlungChGrundimmunisierung(1, 1, impfstoff));
		impfstoff.getImpfempfehlungenChGrundimmunisierung()
			.add(new ImpfempfehlungChGrundimmunisierung(3, 0, impfstoff));
		impfstoff.setKrankheiten(createKrankheiten(KrankheitIdentifier.COVID));
		return impfstoff;
	}

	public static Impfstoff createImpfstoffSinovac() {
		Impfstoff impfstoff = createImpfstoff(Constants.SINOVAC_UUID,
			"CoronaVac",
			"Sinovac",
			2,
			CovidCertificateVaccinesNames.CoronaVac.getCode(),
			"?sinovac?",
			ZulassungsStatus.EXTERN_ZUGELASSEN,
			ZulassungsStatus.EXTERN_ZUGELASSEN,
			Impfstofftyp.ANDERE);
	...
	public static Impfstoff createImpfstoffCovishield() {
		Impfstoff impfstoff = createImpfstoff(Constants.COVISHIELD_UUID,
			"COVISHIELD™",
			"Serum Institute of India Pvt. Ltd",
			2,
			CovidCertificateVaccinesNames.Covishield.getCode(),
			"?covishield?",
			ZulassungsStatus.EXTERN_ZUGELASSEN,
			ZulassungsStatus.EXTERN_ZUGELASSEN,
			Impfstofftyp.ANDERE);
	...
	public static Impfstoff createImpfstoffCOVOVAX() {
		Impfstoff impfstoff = createImpfstoff(Constants.COVOVAX_UUID,
			"COVOVAX™",
			"Serum Institute of India Pvt. Ltd",
			2,
			CovidCertificateVaccinesNames.COVOVAX.getCode(),
			"?covovax?",
			ZulassungsStatus.EXTERN_ZUGELASSEN,
			ZulassungsStatus.EXTERN_ZUGELASSEN,
			Impfstofftyp.ANDERE);
	...
	public static Impfstoff createImpfstoffNovavax() {
		...
		Impfstoff impfstoff = createImpfstoff(Constants.NOVAVAX_UUID,
			"NUVAXOVID™",
			"Novavax",
			2,
			CovidCertificateVaccinesNames.Novavax.getCode(),
			"00380631000045",
			ZulassungsStatus.EMPFOHLEN,
			ZulassungsStatus.EMPFOHLEN,
			Impfstofftyp.ANDERE);
	...
	public static Impfstoff createImpfstoffSputnikLight() {
		Impfstoff impfstoff = createImpfstoff(Constants.SPUTNIK_LIGHT_UUID,
			"Sputnik Light",
	...
	public static Impfstoff createImpfstoffSputnikV() {
		Impfstoff impfstoff = createImpfstoff(Constants.SPUTNIK_V_UUID,
			"Sputnik V",
			"Gamaleya National Centre of epidemiology and Microbiology, "
				+ "Russia",
			2,
			CovidCertificateVaccinesNames.Sputnik_V.getCode(),
			"?sputnik-V?",
			ZulassungsStatus.NICHT_WHO_ZUGELASSEN,
			ZulassungsStatus.NICHT_WHO_ZUGELASSEN,
			Impfstofftyp.ANDERE);
	...
	public static Impfstoff createImpfstoffConvidecia() {
		Impfstoff impfstoff = createImpfstoff(Constants.CONVIDECIA_UUID,
			"Convidecia (Ad5-nCoV)",
			"Convidecia (Ad5-nCoV)",
			1,
			CovidCertificateVaccinesNames.Convidecia.getCode(),
			"?convidecia?",
			ZulassungsStatus.NICHT_WHO_ZUGELASSEN,
			ZulassungsStatus.NICHT_WHO_ZUGELASSEN,
			Impfstofftyp.ANDERE);
		impfstoff.getImpfempfehlungenChGrundimmunisierung()
			.add(new ImpfempfehlungChGrundimmunisierung(1, 2, impfstoff));
		impfstoff.setKrankheiten(createKrankheiten(KrankheitIdentifier.COVID));
		return impfstoff;
	}

	public static Impfstoff createImpfstoffKazakhstan() {
		Impfstoff impfstoff = createImpfstoff(Constants.KAZAKHSTAN_RIBSP_UUID,
			"Kazakhstan RIBSP",
			"QazCovid-in",
			2,
			"TODO-kazakhstan",
		...
		impfstoff.getImpfempfehlungenChGrundimmunisierung()
			.add(new ImpfempfehlungChGrundimmunisierung(1, 2, impfstoff));
		impfstoff.getImpfempfehlungenChGrundimmunisierung()
			.add(new ImpfempfehlungChGrundimmunisierung(2, 1, impfstoff));
		impfstoff.setKrankheiten(createKrankheiten(KrankheitIdentifier.COVID));
		return impfstoff;
	}

	public static Impfstoff createImpfstoffAbdala() {
		Impfstoff impfstoff = createImpfstoff(Constants.ABADALA_CIGB66_UUID,
			"Abadala (CIGB-66)",
	...
	public static Impfstoff createImpfstoffAffenpocken() {
		Impfstoff impfstoff = createImpfstoff(Constants.MVA_BN_UUID,
			"MVA-BN®",
			"Bavarian Nordic",
			2,
			"TODO affenpocken",
			"?todo affenpockencode?",
			ZulassungsStatus.EMPFOHLEN,
			ZulassungsStatus.EMPFOHLEN,
			Impfstofftyp.ANDERE);
		impfstoff.getImpfempfehlungenChGrundimmunisierung()
	...
	public static Impfstoff createImpfstoffForUnbekannteAffenpockenimpfstoffInKindheit() {
		Impfstoff impfstoff = createImpfstoff(Constants.UNBEKANNTE_POCKENIMPFUNG_IN_KINDHEIT_UUID,
			"UNBEKANNTE_POCKENIMPFUNG_IN_KINDHEIT",
			"UNBEKANNTE_POCKENIMPFUNG_IN_KINDHEIT",
			99,
			"TODO affenpocken",
			"?todo affenpockencode?",
	...
	public static Impfstoff createImpfstoffZifivax() {
		Impfstoff impfstoff = createImpfstoff(Constants.RBD_ZIFIVAX_UUID,
			"RBD-Dimer, Zifivax",
			"Anhui Zhifei Longcom, China ZF2001",
			2,
			"TODO-zifivax",
			"?zifivax?",
			ZulassungsStatus.NICHT_WHO_ZUGELASSEN,
	...
	public static Impfstoff createImpfstoff(
		UUID id, String name, String hersteller, int anzahl, String certCode, String code,
	...
	public static OrtDerImpfung createOrtDerImpfung() {
		...
		odi.setFachverantwortungbabKeyCloakId(createBenutzer("Fachverantwortlicher", "Fabian", "123456").getId()
			.toString());
		return odi;
	}
	...
	public static Impftermin createImpftermin(
	...
	public static ImpfinformationDto createImpfinformationen(
		...
		ImpfinformationDto impfinformationDto =
			new ImpfinformationDto(krankheitIdentifier, reg, new Impfdossier(), null);
		...
		if (latestVacmeImpfung != null) {
			...
			impfinformationDto.getImpfdossier()
				.getBuchung()
				.setImpftermin1FromImpfterminRepo(impftermin1); // allowed for unittest
			...
			impfinformationDto.getImpfdossier()
				.getBuchung()
				.setImpftermin2FromImpfterminRepo(impftermin1);// allowed for unittest
			...
			impfinformationDto = new ImpfinformationDto(krankheitIdentifier, reg, null, null, dossier,
				externeImpfinfo);
			if (externeImpfinfo == null) {
				...
				VacmeDecoratorFactory.getDecorator(impfinformationDto.getKrankheitIdentifier())
					.setStatusToImmunisiertWithExternZertifikat(
						impfinformationDto,
						externeImpfinfo,
	...
	public static Impfdossier createDummyImpfdossier(
		...
		Impfschutz impfschutz =
			new Impfschutz(impfschtutzTime, impfschtutzTime, impfschtutzTime, allowedImpfstoffe, false);
	...
	public static ImpfinformationDto addBoosterImpfung(
		@NonNull ImpfinformationDto dto,
		@NonNull LocalDate dateOfBooster) {
	...
	public static ImpfinformationDto addBoosterImpfung(
		...
		Impftermin boosterTermin = createImpftermin(createOrtDerImpfung(),
			booster.getTimestampImpfung().toLocalDate());
	...
	public static ImpfinformationDto addExternesZertifikat(
	 ...
	 */
	@Nullable
	public static VollstaendigerImpfschutzTyp guessVollstaendigerImpfschutzTyp(
	...
	@NonNull
	public static Impfung addBoosterToDossier(
		@NonNull Impfdossier dossier,
		@NonNull LocalDateTime timestampImpfung,
	...
	@NonNull
	public static Impfung createImpfungWithImpftermin(
		@NonNull LocalDateTime timestampImpfung,
		@NonNull Impffolge impffolge) {
		Impfung impfung = new Impfung();
		impfung.setTimestampImpfung(timestampImpfung);
		impfung.setImpfstoff(createImpfstoffModerna());
		impfung.setGrundimmunisierung(Impffolge.ERSTE_IMPFUNG.equals(impffolge) || Impffolge.ZWEITE_IMPFUNG.equals(
			impffolge));
			...
			for (Impfung impfung : infos.getBoosterImpfungen()) {
				if (!impfung.isExtern()) {
					...
					int zahlNachSchraegstrich =
						CovidCertUtils.calculateZahlNachSchraegstrich(infos, infos.getRegistrierung(), impffolgeNr);
					ZertifikatJax zertifikatJax1 =
						createZertifikatJax(impfung, LocalDateTime.now().minusMonths(2).minusDays(1));
					...
					ZertifikatJax zertifikatJax3 =
						createZertifikatJax(impfung, LocalDateTime.now().minusMonths(6).minusDays(5));
	...
	@NonNull
	private static ZertifikatJax createZertifikatJax(
		@NonNull Impfung impfung,
		@NonNull LocalDateTime timestampErstellt) {
	...
	@NonNull
	public static SmsSettingsDTO dummySmsSettingsDTO() {
