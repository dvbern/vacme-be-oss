...
public class FhirService {
	...
	private final FhirResourceMapper fhirResourceMapper = new FhirResourceMapper();
	...
	private void applyCustomNarrativeGenerator(FhirContext ctxR4) {
		...
		CustomThymeleafNarrativeGenerator gen = new CustomThymeleafNarrativeGenerator(vacmeSettingsService.getFhirCustomNarrativePropertyFile());
