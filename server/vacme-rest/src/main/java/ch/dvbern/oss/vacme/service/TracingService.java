...
public class TracingService {
	...
	private static final Set<ImpfdossierStatus> TRACING_RELEVANT_STATUS = Set.of( // Es muss mindestens einmal geimpft worden, sonst ist es fuer Tracing nicht relevant
	...
	private List<TracingRegistrierungJax> mapTracingRegistrierungJaxList(
		...
		return registrierungList.stream()
			.map(registrierung -> {
				...
				return TracingRegistrierungJax.from(registrierung, impfung1, impfung2, boosterImpfungen, zertifikat, vollstaendigerImpfschutzTyp);
			})
