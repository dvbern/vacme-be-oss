...
public class OnboardingHashIdService {
	...
	public static final String onboardingIDAlphabet = "2345789ABCDEFHKMNPRSTWXYZ"; // ohne verwechselbare Buchstaben
	...
	public String getOnboardingHash(long number, String randomElementDigits) {
		String usedSalt = vacmeSettingsService.getOnboardingHashidsSalt();
		if (usedSalt == null) {
			usedSalt = "ONBOARDINGHASH" + getMandantProperty();
		}
		Hashids hashids = new Hashids(usedSalt, vacmeSettingsService.getOnboardingHashidsMinLength(), vacmeSettingsService.getOnboardingHashidsAlphabet());
