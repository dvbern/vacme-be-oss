...
public class DashboardJax {
	...
	public DashboardJax(@NonNull ImpfinformationDto infos, @NonNull Fragebogen fragebogen) {
		...
		if (dossierEntity.getBuchung().getGewuenschterOdi() != null) {
			this.gewuenschterOrtDerImpfung = new OrtDerImpfungDisplayNameJax(dossierEntity.getBuchung().getGewuenschterOdi());
		}
		...
		this.setZweiteImpfungVerzichtetGrund(dossierEntity.getZweiteGrundimmunisierungVerzichtet().getZweiteImpfungVerzichtetGrund());
		this.setPositivGetestetDatum(dossierEntity.getZweiteGrundimmunisierungVerzichtet().getPositivGetestetDatum());
		this.setZweiteImpfungVerzichtetZeit(dossierEntity.getZweiteGrundimmunisierungVerzichtet().getZweiteImpfungVerzichtetZeit());
		...
		this.impfdossier = new ImpfdossierJax(dossierEntity, infos.getBoosterImpfungen(), infos.getExternesZertifikat());
