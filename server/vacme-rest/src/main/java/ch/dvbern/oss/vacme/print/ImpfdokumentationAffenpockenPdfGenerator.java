...
/**
 * Generator fuer Impfbestaetigung fuer Affenpocken
 */
public class ImpfdokumentationAffenpockenPdfGenerator extends AbstractImpfdokumentationPdfGenerator {

	private final List<String> impfungen;

	public ImpfdokumentationAffenpockenPdfGenerator(
	...
	protected PdfGenerator.CustomGenerator getCustomGenerator() {
		return (generator) -> {
			...
			document.add(PdfUtil.createParagraph(translateAllLanguages("print_impfdokumentation_affenpocken_intro", "\n\n") + "\n\n\n", 0));
