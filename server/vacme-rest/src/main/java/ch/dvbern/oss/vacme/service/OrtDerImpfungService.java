...
public class OrtDerImpfungService {
	...
	public List<Impfslot> getFreieImpftermine(
		...
		if (ortDerImpfung.isTerminverwaltung()) {
			return impfterminRepo.findFreieImpfslots(ortDerImpfung, impffolge, date, krankheit);
		}
	...
	public LocalDateTime getNextFreierImpftermin(
		...
		if (ortDerImpfung.isTerminverwaltung()) {
			...
			LocalDateTime impfslotBisTime = impfterminRepo.findNextFreierImpftermin(ortDerImpfung, impffolge, minDate, maxDate, krankheit);
			if (impfslotBisTime == null && otherTerminDate != null) {
				...
				impfslotBisTime = impfterminRepo.findNextFreierImpftermin(ortDerImpfung, impffolge, minDate, maxDate, krankheit);
			}
	...
	public OrtDerImpfung ortDerImpfungErfassen(@NonNull OrtDerImpfungJax ortDerImpfungJax) {
		OrtDerImpfung ortDerImpfung = createOrtDerImpfung(ortDerImpfungJax.getUpdateEntityConsumer(true, geocodeService));
	...
	public OrtDerImpfung updateOrtDerImpfung(@NonNull OrtDerImpfung ortDerImpfung, @NonNull OrtDerImpfungJax ortDerImpfungJax) {
		...
		if (updatedOdi.getOrganisationsverantwortungKeyCloakId() != null) {
			changeUserWithRoleInGroup(FachRolle.ORGANISATIONSVERANTWORTUNG, updatedOdi.getOrganisationsverantwortungKeyCloakId(),
				updatedOdi.getIdentifier());
		}
		return updatedOdi;
	}
	 ...
	 */
	private void changeUserWithRoleInGroup(@NonNull FachRolle fachRolle, @NonNull String keyCloakId, @NonNull String groupIdentifier) {
