...
public class AffenpockenImpfschutzCalcQueueService implements ImpfschutzCalculationQueueService {

	private final BoosterQueueRepo boosterQueueRepo;

	@Override
	public long removeAllSuccessfullQueueEntries() {
		return boosterQueueRepo.removeAllSuccessfullEntries(KrankheitIdentifier.AFFENPOCKEN);
	}

	@Override
	public int queueRelevantRegsForImpfschutzRecalculation() {
		return boosterQueueRepo.queueRelevantRegsForImpfschutzRecalculationAffenpocken();
	}
}
