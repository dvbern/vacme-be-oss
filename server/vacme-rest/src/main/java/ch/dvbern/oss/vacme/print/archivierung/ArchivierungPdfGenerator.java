...
public class ArchivierungPdfGenerator {
	...
	public static PdfOutputIntent getOutputIntent() {
		try {
			InputStream intentStream = ArchivierungPdfGenerator.class.getResourceAsStream(INTENT);
	...
	public static PdfFont getFontArial() {
		try {
			final InputStream fontResource = ArchivierungPdfGenerator.class.getResourceAsStream(FONT_ARIAL);
