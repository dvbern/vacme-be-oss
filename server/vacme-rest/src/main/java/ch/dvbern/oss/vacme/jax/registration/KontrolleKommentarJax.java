...
@AllArgsConstructor
public class KontrolleKommentarJax {
	...
	@Nullable
	public static KontrolleKommentarJax from(
		@Nullable ImpfungkontrolleTermin impfungkontrolleTermin,
		@Nullable Impffolge impffolge,
		@Nullable Integer impffolgeNr
	) {
		if (impfungkontrolleTermin != null && impfungkontrolleTermin.getBemerkung() != null) {
			KontrolleKommentarJax kommentarJax = new KontrolleKommentarJax(
				impfungkontrolleTermin.getBemerkung(),
				impffolge,
				impffolgeNr,
				impfungkontrolleTermin.getTimestampKontrolle());
			return kommentarJax;
		}
		return null;
	}
