...
CREATE TABLE IF NOT EXISTS ImpfempfehlungChGrundimmunisierung (
    ...
    anzahlVerabreicht		  INT 		   NOT NULL,
    notwendigFuerChGrundimmunisierung INT  NOT NULL,
    impfstoff_id			  VARCHAR(36)  NOT NULL,

	CONSTRAINT UC_ImpfempfehlungChGrundimmunisierung_impfstoff_anzahlVerabreich UNIQUE (impfstoff_id, anzahlVerabreicht),
    CONSTRAINT FK_ImpfempfehlungChGrundimmunisierung_impfstoff
    	FOREIGN KEY (impfstoff_id) REFERENCES Impfstoff(id)
);

CREATE TABLE IF NOT EXISTS ImpfempfehlungChGrundimmunisierung_AUD (
	...
	PRIMARY KEY (id, REV),
	CONSTRAINT FK_ImpfempfehlungChGrundimmunisierung_aud_rev
...
/*
-- UNDO:
DROP TABLE ImpfempfehlungChGrundimmunisierung;
DROP TABLE ImpfempfehlungChGrundimmunisierung_AUD;
DELETE from flyway_schema_history where flyway_schema_history.script = 'db/migration/V17.4.1__createImpfempfehlungChGrundimmunisierung.sql';
*/
