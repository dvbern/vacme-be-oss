...
SELECT '765dd8e2-5294-4d85-87bb-6fce77362348', (SELECT id FROM Krankheit WHERE identifier = 'COVID');
...
DELETE FROM Impfstoff_Krankheit where impfstoff_id = '765dd8e2-5294-4d85-87bb-6fce77362348';
...
DELETE from flyway_schema_history where flyway_schema_history.script = 'db/migration/V19.0.16__impfstoffPfitzerBivalent.sql';
