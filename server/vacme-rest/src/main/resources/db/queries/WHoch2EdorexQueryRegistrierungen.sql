...
(select Registrierung.id as 'Registrierungs_ID',
		...
		CASE WHEN dossier.vollstaendigerImpfschutzTyp IS NOT NULL
				 THEN 'TRUE'
			 ELSE 'FALSE' END as 'Vollstaendiger_Impfschutz',
		Fragebogen.chronischeKrankheiten as 'Chronische_Krankheiten', Fragebogen.lebensumstaende as 'Lebensumstaende',
		Fragebogen.beruflicheTaetigkeit as 'Beruf', Registrierung.prioritaet as 'Imfgruppe',
		Registrierung.verstorben as 'Verstorben',
