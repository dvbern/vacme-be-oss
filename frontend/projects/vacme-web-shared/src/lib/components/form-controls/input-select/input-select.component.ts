...
const LOG = LogFactory.createLog('InputSelectComponent');
...
export class InputSelectComponent extends FormControlBase implements OnChanges {
    @Input()
    key!: string;
