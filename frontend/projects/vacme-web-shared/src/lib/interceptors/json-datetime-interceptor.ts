...
export function bodyToFrontend(body: any, config: Configurator): any {
    ...
    const result = cloneDeepWith(body, (value: any, key: number | string | undefined, ignoreObj, ignoreStack: any): any => {
...
function valueToFrontend(value: any, _: Configurator): Date {
