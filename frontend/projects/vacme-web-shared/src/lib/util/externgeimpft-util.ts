...
export class ExternGeimpftUtil {
    ...
    private static changeHandlerPositivGetestetDatum(formGroup: UntypedFormGroup, krankheit: KrankheitIdentifierTS): void {
    ...
    private static changeHandlerDatumLetzteImpfung(formGroup: UntypedFormGroup, krankheit: KrankheitIdentifierTS): void {
    ...
    public static hasBeenExternGeimpft(formGroup: UntypedFormGroup): boolean {
        return formGroup?.get('externGeimpft')?.value;
    }

    public static isGenesen(formGroup: UntypedFormGroup): boolean {
        return formGroup?.get('genesen')?.value;
    }

    public static isDatumLetzteImpfungUnbekannt(formGroup: UntypedFormGroup): boolean | null | undefined {
        return formGroup?.get('letzteImpfungDateUnknown')?.value;
    }

    public static onExterngeimpftChange(formGroup: UntypedFormGroup, value?: boolean): void {
        if (!value) {
    ...
    public static updateFormFromModel(formGroup: UntypedFormGroup, externGeimpft: ExternGeimpftJaxTS,
    ...
    public static showPositivGetestetDatum(formGroup: UntypedFormGroup, krankheit: KrankheitIdentifierTS): boolean {
        return this.showGenesen(krankheit) && this.isGenesen(formGroup);
    }

    public static showTrotzdemVollstaendigGrundimmunisieren(formGroup: UntypedFormGroup, krankheit: KrankheitIdentifierTS): boolean {
        if (KrankheitIdentifierTS.COVID === krankheit) {
    ...
    public static showDatumLetzteImpfung(formGroup: UntypedFormGroup, krankheit: KrankheitIdentifierTS): boolean {
