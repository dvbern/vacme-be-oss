...
export class PersonalienSucheComponent implements OnInit {
    ...
    public personalienGroup!: UntypedFormGroup;
    public matchFormArray?: UntypedFormArray;
    ...
    public getResultGroups(): UntypedFormGroup[] {
        return this.matchFormArray?.controls as UntypedFormGroup[];
    }
    ...
    public navigateToPersonendatenEdit(group: UntypedFormGroup): void {
