...
import {resolveDossiersOverview} from './service/resolver/dossiers-overview-resolver.service';
import {resolveEzImpfstoff} from './service/resolver/ez-impfstoff-resolver.service';
import {resolveRegistrierungId} from './service/resolver/registrierung-id-resolver.service';
...
const routes: Routes = [
    ...
    },
    {
        ...
        resolve: {
            personalien: resolveRegistrierungId
        }
    },
    {
    ...
    },
    {
        ...
        resolve: {
            dossiersOverview: resolveDossiersOverview,
        }
    },
    {
