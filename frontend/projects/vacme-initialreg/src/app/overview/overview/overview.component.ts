...
export class OverviewComponent implements OnInit, OnChanges, OnDestroy {
    ...
    public erkrankungenConfirmFromGroup!: UntypedFormGroup;
    public selbstzahlerConfirmFormGroup!: UntypedFormGroup;

    public odiFilterFormGroup!: UntypedFormGroup;
    ...
    ngOnInit(): void {
        ...
        this.langChangeSubscription =
            this.translationService.onLangChange.subscribe((_: TranslationChangeEvent) => {
                this.refreshOdiOptions();
        ...
        this.dossierService.dossierResourceRegGetAllZertifikate(this.getKrankheit(),
    ...
    public downloadRegistrationsbestaetigung(): void {
        ...
        }, _ => LOG.error('Registrierungsbestaetigung konnte nicht heruntergeladen werden'));
    }
    ...
    public downloadTerminbestaetigung(): void {
        ...
        this.dossierService.dossierResourceRegDownloadTerminbestaetigung(
            ...
            error => {
                ...
                // anzuzeigen:
                void BlobUtil.parseErrorMessage(error.error, ['AppValidationMessage.ILLEGAL_STATE'])
    ...
    public downloadImpfdokumentation(): void {
        ...
        }, _ => console.error('Impfdokumentation konnte nicht heruntergeladen werden'));
    }
    ...
    public downloadZertifikat(): void {
        ...
        this.dossierService.dossierResourceRegDownloadBestZertifikatForRegistrierung(this.getKrankheit(),
            registrierungsnummer)
            .subscribe(res => {
                this.filesaver.save(res, this.translationService.instant('FILES.COVID_IMPFZERTIFIKAT'));
            }, _ => console.error('Zertifikat konnte nicht heruntergeladen werden'));
    }
    ...
    public getBoosterFreigabetext(): string {
        ...
        if (RegistrierungStatusTS.IMMUNISIERT === status) {
            ...
            if (this.vacmeSettingsService.supportsTerminFreigabeSMS(this.getKrankheit()) && !this.isSelbstzahler()) {
                ...
                const dateValue = this.dashboardJax.impfdossier?.impfschutzJax?.freigegebenNaechsteImpfungAb;
                return this.translationService.instant(keyToTranslate, {
                    ...
                    date: formatDate(dateValue ? dateValue : '',
    ...
    zurueckZuWellClicked(): void {
        window.open(this.vacmeSettingsService.wellUrl, '_self');
    }
    ...
    public downloadSpecificZertifikat(zertifikat: ZertifikatJaxTS): void {
        if (this.dashboardJax.registrierungsnummer && zertifikat.id) {
            this.dossierService.dossierResourceRegDownloadZertifikatWithId(
                ...
                .subscribe(res => {
                    this.filesaver.save(res, this.translationService.instant('FILES.COVID_IMPFZERTIFIKAT'));
                }, _ => LOG.error('Zertifikat konnte nicht heruntergeladen werden'));
        }
    }
    ...
    public dataAnpassen(): void {
        void this.router.navigate(['cc-adresse-edit', this.dashboardJax.registrierungsnummer]);
    }
