...
export class NavigationService {
    ...
    public navigateToStartpage(
        ...
        if (TenantUtil.isMultiKrankheitGUI()) {
            this.router.navigate(['impfdossiers-overview', registrierungsnummer]);
        } else {
    ...
    public navigateToDossierAddition(registrierungsnummer: string | undefined): void {
        if (TenantUtil.isMultiKrankheitGUI()) {
            this.router.navigate(['impfdossiers-auswahl', registrierungsnummer]);
        } else {
    ...
    public navigatePreRegistration(keycloakRegistration: () => Promise<void>): void {
        if (TenantUtil.isMultiKrankheitGUI()) {
           ...
           this.navigateToImpffaehigkeit();
        }
    }

    public navigatePostKeycloakRegistration(): void {
        if (TenantUtil.isMultiKrankheitGUI()) {
           this.navigateToPersonendaten();
        } else {
            this.navigateToImpffaehigkeit();
        }
    }
    ...
    public navigateToExternGeimpftPage(
        ...
        this.router.navigate(['/externgeimpft', registrierungsnummer, 'krankheit' , krankheit]);
    }
    ...
    public navigateToLeistungserbringerAgbPage(
        ...
        this.router.navigate(['/leistungserbringer-agb', registrierungsnummer, 'krankheit' , krankheit]);
    }
}
