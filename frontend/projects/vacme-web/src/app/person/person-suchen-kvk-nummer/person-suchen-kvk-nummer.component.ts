...
} from '../../../../../vacme-web-shared/src/lib/util/customvalidator/krankenkassenkartennummer-validator';
...
export class PersonSuchenKvkNummerComponent implements OnInit {
    ...
    openDossier(reg: RegistrierungBasicInfoJaxTS): void {
        this.dossierService.dossierResourceGetImpfdossiersOverview(reg.registrierungsnummer as string).subscribe(
