...
export class OdiPersonalienUVCISuchePageComponent extends BaseDestroyableComponent {
    ...
    public suchen(code: string): void {
        this.dossierService.dossierResourceGetImpfdossiersOverview(code).subscribe(
