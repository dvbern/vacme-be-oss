...
import {SysImpfstoffePageComponent} from './sys-impfstoffe-page/sys-impfstoffe-page.component';
import {resolveSysTerminPage} from './sys-termin-page/sys-termin-page-resolver.resolver';
