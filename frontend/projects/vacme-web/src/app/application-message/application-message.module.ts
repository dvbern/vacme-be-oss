...
import {ApplicationMessageRoutingModule} from './application-message-routing.module';
...
@NgModule({
    declarations: [
        ApplicationMessagePageComponent,
    ...
    imports: [
        ...
        FormsModule,
        ReactiveFormsModule,
        ApplicationMessageRoutingModule,
        TranslateModule.forChild()
    ]
})
export class ApplicationMessageModule {
}
