...
export const resolveGeimpft: ResolveFn<Observable<any>> =
    (route: ActivatedRouteSnapshot, state: RouterStateSnapshot) => {
        ...
        // Die aktuelle geimpft-Seite braucht ein Covid-Dossier plus eine Liste von DossierSummaries pro Krankheit
        const dashboardCovidRequest$ = dossierService.dossierResourceGetDashboardImpfdossier(KrankheitIdentifierTS.COVID, regNummer);
