...
export const resolveKontrolle: ResolveFn<Observable<any>> =
    (route: ActivatedRouteSnapshot, _: RouterStateSnapshot) => {
        ...
        if (registrierungsnummer !== undefined && registrierungsnummer !== 'new' && krankheitFromRoute) {
            const fileInfoRequest$ = dossierService.dossierResourceGetFileInfo(krankheitFromRoute, registrierungsnummer);
