...
export const resolveImpfstoffZugelassene: ResolveFn<Observable<Array<ImpfstoffJaxTS>>> =
    (ignoreRoute: ActivatedRouteSnapshot, ignoreState: RouterStateSnapshot) => {
        const stammdatenService = inject(StammdatenService);
        return stammdatenService.stammdatenResourceGetZugelasseneImpfstoffeList();
    };
