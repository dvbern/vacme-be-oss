...
import {ImpfdokumentationService} from 'vacme-web-generated';
import {extractKrankheitFromRoute} from '../../../../../vacme-web-shared/src/lib/util/krankheit-utils';


export const resolveCanBeGrundimmunisierung: ResolveFn<Observable<boolean>> =
        ...
        if (registrierungsnummer) {
            ...
            if (krankheitFromRoute) {
                const canBeGrundimmunisierung$ =
                    impfdokumentationService.impfdokumentationResourceCanBeGrundimmunisierung(
