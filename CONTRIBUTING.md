...
First off, thank you for considering contributing to VacMe!
### 1. Where do I go from here?

If you've noticed a bug or have a question that doesn't belong on the
[wiki](https://github.com/dvbern/vacme/wiki), then
[search the issue tracker](https://github.com/dvbern/vacme/issues)
to see if someone else in the community has already created a ticket regarding your issue.
If not, feel free to go ahead and [make one](https://github.com/dvberm/vacme/issues/new)!

### 2. Did you find a bug?

* **Ensure the bug was not already reported** by searching on GitHub under 
[Issues](https://github.com/dvbern/vacme/issues).

* If you're unable to find an open issue addressing the problem, 
[open a new one](https://github.com/dvbern/vacme/issues/new). 
...
[fork (VacMe)](https://help.github.com/articles/fork-a-repo)
...
```sh
git remote add upstream git@github.com/dvbern/vacme.git
git checkout master
